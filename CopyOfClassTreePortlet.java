 ...
 */
public class CopyOfClassTreePortlet extends AbstractOWLEntityPortlet {
    ...
    */
    ...
    public CopyOfClassTreePortlet(final Project project) {
        this(project, true, true, true, true, null);
    }

    public CopyOfClassTreePortlet(final Project project, final boolean showToolbar, final boolean showTitle, final boolean showTools, final boolean allowsMultiSelection, final String topClass) {
        super(project, false);
        ...
        if (selModel instanceof DefaultSelectionModel) {
            ((DefaultSelectionModel) selModel).addSelectionModelListener(new DefaultSelectionModelListenerAdapter() {
                ...
                public void onSelectionChange(final DefaultSelectionModel sm, final TreeNode node) {
                    notifySelectionListeners(new SelectionEvent(CopyOfClassTreePortlet.this));
                }
            });
        }
        ...
        searchField.addListener(new TextFieldListenerAdapter() {
            ...
            public void onSpecialKey(final Field field, final EventObject e) {
                if (e.getKey() == EventObject.ENTER) {
                    SearchUtil searchUtil = new SearchUtil(getProjectId(), CopyOfClassTreePortlet.this, getSearchAsyncCallback());
...
//        switch (watchType) {
        if(w.iterator().next() instanceof EntityFrameWatch) {
            return "<img src=\"images/eye.png\" " + CopyOfClassTreePortlet.WATCH_ICON_STYLE_STRING + " title=\"" + " Watched\"></img>";
//            return "<img src=\"images/tag_blue.png\" " + ClassTreePortlet.WATCH_ICON_STYLE_STRING + " title=\"" + " Watched\"></img>";
        }
        else {
            return "<img src=\"images/eye-down.png\" " + CopyOfClassTreePortlet.WATCH_ICON_STYLE_STRING + " title=\"" + " Watched branch\"></img>";
