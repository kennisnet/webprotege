...
import edu.stanford.bmir.protege.web.client.ui.projectdetails.ProjectDetailsPortlet;
...
public class UIFactory {
    ...
    public static EntityPortlet createPortlet(Project project, String portletJavaClassName) {
        try {
            ...
            else if(portletJavaClassName.equals(ProjectDetailsPortlet.class.getName())) {
                return new ProjectDetailsPortlet(project);
            }
        }
        catch (Exception e) {
