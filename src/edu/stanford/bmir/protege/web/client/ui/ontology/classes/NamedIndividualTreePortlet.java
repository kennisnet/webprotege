...
public class NamedIndividualTreePortlet extends AbstractOWLEntityPortlet {
    ...
    public NamedIndividualTreePortlet(final Project project, final boolean showToolbar, final boolean showTitle,
            ...
            ((DefaultSelectionModel) selModel)
                    .addSelectionModelListener(new DefaultSelectionModelListenerAdapter() {
                        ...
                        public void onSelectionChange(final DefaultSelectionModel sm, final TreeNode node) {
                            notifySelectionListeners(new SelectionEvent(NamedIndividualTreePortlet.this));
                        }
                    });
        ...
        searchField.addListener(new TextFieldListenerAdapter() {
            ...
            public void onSpecialKey(final Field field, final EventObject e) {
                if (e.getKey() == EventObject.ENTER) {
                    SearchUtil searchUtil = new SearchUtil(getProjectId(), NamedIndividualTreePortlet.this,
